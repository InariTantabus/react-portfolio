...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.handleThumbDrop = this.handleThumbDrop.bind(this);        this.handleThumbDrop = this.handleThumbDrop.bind(this);
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.portfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url: url || "",
                editMode: true,
                apiUrl: `https://arcticsoul.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAction: 'patch',
